...
export default class SuggestionBoxWebPart extends BaseClientSideWebPart<ISuggestionBoxWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ISuggestionBoxProps> = React.createElement(
      SuggestionBox,
      {
        context: this.context,
        header: this.properties.header,
        suggestionBoxList: this.properties.suggestionBoxList
      }
    );
          ...
          groups: [
            {
              ...
              groupFields: [
                PropertyPaneTextField('header', {
                  label: "Webpart Header"
                }),
                PropertyPaneTextField('suggestionBoxList', {
                  label: "Suggestion Box List Name"
                })
              ]
            }
          ]
